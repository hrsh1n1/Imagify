    ...
    <div className='fixed top-0 left-0 right-0 bottom-0
     ...
     items-center'>
        ...
        text-slate-500'>
            ...
            <button className='bg-blue-600 w-full text-white py-2 rounnded-full'>{state=== 'Login' ? 'Login' : 'Create Account'}</button>
            ...
            <p className='mt-5 text-center'>Already have an account? 
                <span className='text-blue-600 cursor-pointer' onClick={()=>setState('Login')}> Sign In</span></p>
